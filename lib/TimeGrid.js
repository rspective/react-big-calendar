...
var TimeGrid = (function(_Component) {
  ...
  function TimeGrid(props) {
    ...
    _this.state = { gutterWidth: undefined, isOverflowing: true }
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(
    ...
    var renderHeaderRow = range.length !== 1
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function(date, i) {
      ...
      var label = _localizer2.default.format(date, weekdayFormat, culture)
...
TimeGrid.propTypes = {
  ...
  iconAccessor: _propTypes3.accessor.isRequired,
